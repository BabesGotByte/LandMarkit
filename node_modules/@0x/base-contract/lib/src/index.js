...
var BaseContract = /** @class */ (function () {
    ...
    function BaseContract(contractName, abi, address, supportedProvider, callAndTxnDefaults, logDecodeDependencies) {
        var _this = this;
        ...
        _.each(logDecodeDependencies, function (dependencyAbi, dependencyName) {
            _this._web3Wrapper.abiDecoder.addABI(dependencyAbi, dependencyName);
        });
    }
